...
from cmip7_HI import fix_esm15_sm_ancil_date
...
def load_sm_dms(args):
    # Use the CMIP6 DMS
    dms_ancil_dirpath = (
        esm_sm_aerosol_ancil_dirpath(args.esm15_inputs_dirname)
        / args.esm_grid_rel_dirname
        / args.esm15_aerosol_version
    )
    return load_dms(args, dms_ancil_dirpath, fix_esm15_sm_ancil_date)
