"""
This script interpolates CMIP7 historical emissions CO2 data to the ESM1.6 grid
and saves the result as an ancillary file.
It loads the CMIP7 historical emissions CO2 data, aggregates the sector and
altitude dimensions, regrids the data to match the ESM1.6 grid, and saves the
result as an ancillary file.
...
def cmip7_eh_co2_anthro_interpolate(args):
    ...
    identified in the ESM1.6 model.
    """
    ...
    """
    Save the regridded CO2 emissions data as an ancillary file in the specified
    directory.
    """
...
if __name__ == "__main__":
    """
    Interpolate CMIP7 historical emissions CO2 data to the ESM1.6 grid and save
