...
from cylc_workflow.lib.python.cmip7_inputs.models.access_esm1p6.generators.solar._picontrol import patch_pi_solar
...
def generate_solar_picontrol(request: GenerationRequest) :
    ...
    args = parse_additional_args(request)
    dirpath = get_solar_dirpath(args, "CMIP", "fx")
